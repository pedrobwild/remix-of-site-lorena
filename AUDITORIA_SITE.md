...
- **Status:** **decidido em 17/09/2026 (marketing): domínio oficial `bewild.com.br`; `bwild.com.br` vira site legado com 301 URL por URL.** Mapa completo (36 posts, 12 páginas, 110 projetos do portfólio, categorias pendentes) em `docs/auditoria/mapa-redirecionamento-wix.md`; execução pela API do Wix após revisão.
