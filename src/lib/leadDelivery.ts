...
export type LeadPayload = {
   ...
   * casam o evento com o browser; `ads_consent` registra se o visitante
   * aceitou cookies (informativo — a função envia à Meta mesmo sem aceite,
   * salvo `META_CAPI_REQUIRE_CONSENT=true`).
   */
