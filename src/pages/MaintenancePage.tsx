/**
 * MaintenancePage — página de espera renderizada pelo gate MAINTENANCE_MODE
 * (ver src/router.tsx e src/config/site.ts). Substitui todo o site público
 * enquanto a flag estiver ativa. Autocontida: sem nav/footer/CTA globais.
 */
...
export default function MaintenancePage() {
  ...
  const wa = whatsappHref(CONTACT.whatsappText);
  const ig = CONTACT.instagram;
  const igHandle = "@bewild.oficial";
      ...
      <main>
        <section className="hero" aria-label="Bewild">
          <h1 className="name">
            ...
            <span className="bewild">
              Você leu Be<em>wild.</em>
            </span>
          </h1>
          <p className="lede">
            Talvez seu instinto estivesse certo. A gente está construindo uma marca nova pra um jeito
            de investir em imóvel que te devolve <em>o tempo.</em>
          </p>
        ...
        <section className="section sec-light">
          <div className="inner reveal">
            ...
            <h2 className="h">
              Comprar imóvel pra render não deveria virar <em>um emprego.</em>
            </h2>
            <p className="p">
              Comprar um imóvel pra ter renda costuma virar obra que atrasa, orçamento que estoura e
              fornecedor que some. Não era isso que você imaginou quando decidiu investir.
            </p>
            <p className="p">
              <strong>Ser Wild é ter o ativo sem ser dominado por ele.</strong> A Bewild entrega o
              studio pronto pra render, sem você entrar na obra.
            </p>
          </div>
        </section>
        ...
        <section className="section sec-dark">
          <div className="inner reveal">
            ...
            <h2 className="h">
              Uma a uma, as responsabilidades <em>deixam de ser suas.</em>
            </h2>
          ...
          <div className="inner reveal">
            <div className="video-bloco">
              <div className="video-texto">
                ...
                <h2 className="vt-h">
                  Quem projeta o seu studio mede ele <em>pessoalmente.</em>
                </h2>
                <p className="vt-p">
                  A arquiteta vai até o imóvel e decide ali o que muda na diária: circulação, ponto
                  de luz, onde a cama rende foto. Cada milímetro pensado pro studio operar bem, não
                  só pra ficar bonito.
                </p>
              </div>
            ...
            <div className="video-bloco invertido">
              ...
              <div className="video-texto">
                ...
                <h2 className="vt-h">
                  A obra que você não toca tem <em>time próprio.</em>
                </h2>
                <p className="vt-p">
                  Quem reforma o seu studio trabalha na Bewild, não é um terceiro que aparece e
                  some. Você acompanha o andamento à distância e recebe o imóvel pronto pra operar.
                </p>
              </div>
            </div>
          </div>
        ...
        <section className="section sec-light">
          <div className="inner reveal proposito">
            ...
            <h2 className="h">
              ...
              <br />
              A gente só <em>devolve ela pra você.</em>
            </h2>
            <p className="p">
              Ninguém investe sonhando em virar gerente de obra. A Bewild faz a reforma inteira, do
              projeto à entrega, e te devolve o imóvel pronto pra render do jeito que você imaginou
        ...
        <section className="section sec-dark">
          <div className="inner reveal cta-wrap">
            <p className="tag" style={{ color: "var(--gold-400)" }}>
              a marca está mudando
            </p>
            <h2 className="h">
              O novo site está chegando.
              <br />
              Enquanto isso, <em>vem com a gente.</em>
            </h2>
            <p className="p" style={{ margin: "0 auto" }}>
              A gente está no meio de uma mudança de marca. Até o novo site ficar pronto, fala com a
              gente por aqui:
            </p>
            <div className="cta-row">
              ...
              <a className="btn btn-ig" href={ig} target="_blank" rel="noopener noreferrer">
            ...
            <div className="soon">
              <span className="pulse" /> novo site em breve
            </div>
          </div>
        </section>
      </main>
        ...
        <div className="foot-inner">
          <div className="foot-top">
            <p className="foot-claim">
              Renda sem virar <em>gerente de obra.</em>
            </p>
