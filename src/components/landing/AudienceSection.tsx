      ...
      <Container>
        <SectionHeading
          ...
          title={
            <>
              ...
              <span className="italic text-bewild-blue">sem virar gerente de obra.</span>
            </>
          }
        />
        ...
        <div className="mt-12 grid gap-4 sm:grid-cols-2 lg:grid-cols-3">
          {AUDIENCE.map((item) => (
            <article
              key={item.title}
              className="flex items-start gap-4 rounded-xl border border-bewild-line bg-white p-6 transition-colors hover:border-bewild-blue/40"
            >
