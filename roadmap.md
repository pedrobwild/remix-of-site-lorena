...
- [ ] Aplicar rodada 2 do painel Analytics (arquivos A–G prontos): migration de registro, analyticsCompare v2, OverviewTab, testes, TZ fixo no vitest.config, package-lock regenerado; build + testes sem TZ; não publicar.
